...
public class PPAnimationControllers {
    ...
    */
    ...
    public static final BlendValueController NOT_RIDING_BLEND = new BlendValueController("riding_blend", 0.2f, (model, entity, limbSwing, limbSwingAmount, ageInTicks, animTime, netHeadYaw, headPitch, deltaTime)
            -> entity.getVehicle() == null
    );

    public static final BlendValueController ON_GROUND_AND_NOT_WATER_BLEND = new BlendValueController("on_ground_or_water", 0.2f, (model, entity, limbSwing, limbSwingAmount, ageInTicks, animTime, netHeadYaw, headPitch, deltaTime)
