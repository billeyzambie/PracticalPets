...
public class PPTags {
    ...
    public static class EntityTypes {
        public static final TagKey<EntityType<?>> EXPLOSIVE_ENEMIES = tag("explosive_enemies");

        private static TagKey<EntityType<?>> tag(String name)
        {
            return TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(PracticalPets.MODID, name));
        }
    }
}
