...
//    );
    ...
    public static final RegistryObject<Item> INFO_BOOK = register(
            "info_book",
            InfoBook::new
    );
    public static final RegistryObject<Item> PIRANHA = register(
            "piranha",
            () -> new Item((new Item.Properties()).food(Foods.COD))
    );
    public static final RegistryObject<Item> COOKED_PIRANHA = register(
            "cooked_piranha",
            () -> new Item((new Item.Properties()).food(Foods.COOKED_COD))
    );
    public static final RegistryObject<Item> PIRANHA_BUCKET = register(
            "piranha_bucket",
            () -> new MobBucketItem(
                    PPEntities.PIRANHA,
                    () -> Fluids.WATER,
