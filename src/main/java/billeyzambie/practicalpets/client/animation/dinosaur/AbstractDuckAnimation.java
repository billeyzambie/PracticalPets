package billeyzambie.practicalpets.client.animation.dinosaur;
...
public class AbstractDuckAnimation {
    ...
    public static final AnimationDefinition angry = AnimationDefinition.Builder.withLength(0.0F).looping()
            ...
            .addAnimation("haha", new AnimationChannel(AnimationChannel.Targets.SCALE,
    ...
    public static final AnimationDefinition flap2 = AnimationDefinition.Builder.withLength(10.0F)
    ...
    public static final AnimationDefinition quack = AnimationDefinition.Builder.withLength(0.35F)
            .addAnimation("bone", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.2833F, KeyframeAnimations.degreeVec(-10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.3167F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
    ...
    public static final AnimationDefinition pop = AnimationDefinition.Builder.withLength(0.2F)
            .addAnimation("pop", new AnimationChannel(AnimationChannel.Targets.SCALE,
